                        ...
                        <tbody>
                            <%
                                ...
                                if (orders != null && !orders.isEmpty()) {
                                    for (Order o : orders) {
                                        Model.Supplier sup = new DAL.SupplierDAO().getSupplierById(o.getSupplierId());
                                        String supplierName = (sup != null) ? sup.getSupplierName() : "Không xác định";

                                        Model.User user = new DAL.UserDAO().getAllUsers().stream()
                                            .filter(u -> u.getUserId() == o.getOrderedBy())
                                            .findFirst().orElse(null);
                                        String orderedByName = (user != null) ? user.getFullName() : String.valueOf(o.getOrderedBy());
                            %>
                            <tr>
                                <td><%= o.getOrderId() %></td>
                                <td><%= supplierName %></td>
                        ...
                        <%   }
                                                            ...
                                                            function applyOrderFilter() {
                                                                ...
                                                                document.querySelectorAll('#ordersTable tbody tr').forEach(tr => {
                                                                    ...
                                                                    let ok = true;
                                                                    if (kw)
                                                                        ok = id.includes(kw) || supplier.includes(kw);
                                                                    if (ok && st && status !== st)
                                                                        ok = false;
