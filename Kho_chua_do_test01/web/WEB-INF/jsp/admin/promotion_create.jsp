...
<head>
    ...
    <title>Tạo Khuyến Mãi Mới - VIP Store</title>
...
<body style="background-color: #f8f9fa;">
    ...
    <div class="container-fluid px-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted mb-0">Thêm chương trình khuyến mãi mới cho cửa hàng</p>
            </div>
                    ...
                    <form method="post" action="Promotions" id="promotionForm">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" id="discountPercent" name="discountPercent" 
                                                   min="1" max="100" step="0.01" placeholder="0.00" required>
                        ...
                        <div class="form-section">
                            ...
                            <div class="mb-3">
                                ...
                                <!-- Product selection area -->
                                <div class="product-selection-area" style="max-height: 300px; overflow-y: auto; border: 2px solid #e9ecef; border-radius: 10px; padding: 15px;">
                                    <div id="productsList">
    ...
    <script>
        ...
        document.getElementById('promotionForm').addEventListener('submit', function(e) {
            ...
            // Product validation is optional - empty means all products
            const selectedProducts = $('#productDetailIds').val();
            if (!selectedProducts || selectedProducts.length === 0) {
                const confirmAll = confirm('Không chọn sản phẩm nào có nghĩa là áp dụng cho TẤT CẢ sản phẩm. Bạn có chắc chắn?');
                if (!confirmAll) {
                    e.preventDefault();
                    return;
                }
