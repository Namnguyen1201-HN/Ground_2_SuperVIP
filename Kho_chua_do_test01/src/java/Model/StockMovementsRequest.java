...
public class StockMovementsRequest {
    ...
    public Integer getFromSupplierId() { return fromSupplierId; }
    public void setFromSupplierId(Integer fromSupplierId) { this.fromSupplierId = fromSupplierId; }
    ...
    public List<StockMovementDetail> getDetails() { return details; }
    public void setDetails(List<StockMovementDetail> details) { this.details = details; }
}
