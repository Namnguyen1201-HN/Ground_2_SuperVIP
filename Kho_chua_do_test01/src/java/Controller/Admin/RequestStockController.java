 ...
 * @author Admin
 */
@WebServlet(name = "RequestStockController", urlPatterns = {"/request-stock"})
public class RequestStockController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            if (userIdObj == null || roleIdObj == null || branchIdObj == null) {
            ...
            if (keyword != null && !keyword.isBlank()) {
                products = dao.searchProductsByName(branchId, keyword);
            } else {
                products = dao.getAvailableProductsByBranch(branchId);
            }
            ...
            if (draft != null && !draft.isEmpty()) {
                List<ProductDetails> allProducts = dao.getAvailableProductsByBranch(branchId);
            ...
            req.getRequestDispatcher("/WEB-INF/jsp/manager/stockmovement-request.jsp").forward(req, resp);
        ...
        if ("add".equals(action)) {
            ...
            if (idStr != null && !idStr.trim().isEmpty()) {
                ...
                if (!found) {
                    ...
                    if (allProducts == null) {
                        try {
                            allProducts = dao.getAvailableProductsByBranch(branchId);
